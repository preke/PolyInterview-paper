...
\input{figures/table_deploy.tex}
...
\input{figures/table_llm_agent_panel.tex}
...
Gating first selects aspects a question can elicit and then aggregates the corresponding features; inactive aspects remain unscored rather than becoming weaknesses. The report preserves the path from proficiency track to aspect, features, and response evidence, so a lower score can be attributed to specific content, delivery, or non-verbal signals rather than an unexplained overall judgment.
